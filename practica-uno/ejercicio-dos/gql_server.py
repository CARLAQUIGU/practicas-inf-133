...
class Query(ObjectType):
    plantas = List(Planta)
    plantas_por_especie = Field(Planta, especie=String())
    plantas_con_frutos = Field(Planta)
...
plantas = [
    Planta(id=1, nombre_comun="Cactus", especie="Cactaceae", edad=12, altura=20.5, frutos=False),
    Planta(id=2, nombre_comun="Rosa", especie="Rosa spp.", edad=6, altura=30.0, frutos=True),
]
